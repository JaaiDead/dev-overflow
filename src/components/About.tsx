...
function StatCount({
  ...
  return (
    <div className="text-center">
      <div className="font-display text-5xl text-accent leading-none mb-1">
        {run ? n : 0}
        {suffix}
      </div>
      <div className="font-mono text-xs text-text-dim dark:text-dark-text-dim uppercase tracking-widest">
        {label}
      </div>
    </div>
  );
        ...
        <div className="grid md:grid-cols-5 gap-12">
          ...
          <div className="md:col-span-2 space-y-8">
              ...
              {isPersonal ? (
                <>
                  <p className="text-text-dim dark:text-dark-text-dim leading-relaxed mb-4">
                    ...
                    - a developer and student passionate about building clean, creative software.
                    Started with shaping Minecraft worlds, grew into full-stack web dev.
                  </p>
                  <p className="text-text-dim dark:text-dark-text-dim leading-relaxed mb-4">
                ...
                <>
                  <p className="text-text-dim dark:text-dark-text-dim leading-relaxed mb-4">
                    ...
                    is a professional game development and modding studio founded by Jaai. We
                    specialize in creating custom Minecraft modifications, modern web applications,
                    and open-source solutions.
                  </p>
                  <p className="text-text-dim dark:text-dark-text-dim leading-relaxed mb-4">
                    With years of experience in the{" "}
                    <span className="text-accent">Fabric modding ecosystem</span> and modern web
                    technologies, we deliver high-quality, maintainable code that exceeds
                    expectations.
                  </p>
                  <p className="text-text-dim dark:text-dark-text-dim leading-relaxed">
                    From custom server mods to full-stack web apps - we turn your ideas into
                    reality.
                  </p>
                </>
              )}
            ...
            <div
              className={
                reveal(150) +
                " grid grid-cols-3 gap-4 p-5 glass-clay hover:shadow-clay-hover transition-all"
              }
            >
              {STATS.map((s) => (
                <StatCount
            ...
            {/* GitHub Stats Card */}
            <div
              className={reveal(175) + " p-5 glass-lg hover:shadow-clay-hover transition-all group"}
            >
              <p className="font-mono text-xs text-text-dim dark:text-dark-text-dim uppercase tracking-widest mb-4">
                // GitHub Activity
              </p>
              <a
          ...
          <div className="md:col-span-3">
            <div className={reveal(120) + " mb-6"}>
              <p className="font-mono text-xs text-text-dim dark:text-dark-text-dim uppercase tracking-widest mb-5">
                // skills & tools
              </p>
                  ...
                  >
                    <div className="flex items-center justify-between mb-1.5">
                      <div className="flex items-center gap-2">
                        ...
                        <span
                          className={`font-mono text-[9px] px-1.5 py-0.5 rounded border ${catColor[s.cat]}`}
                        >
                          {catLabel[s.cat]}
                        </span>
                      </div>
                    ...
                    <div className="h-1 bg-border dark:border-dark-border rounded-full overflow-hidden shadow-clay-inner">
                      <div
                        ...
                        style={{
                          ...
                          boxShadow: visible
                            ? `0 0 10px ${s.cat === "lang" ? "rgba(14,165,233,0.4)" : s.cat === "fw" ? "rgba(139,92,246,0.4)" : "rgba(0,0,0,0.2)"}`
                            : "none",
                        }}
                      />
                    </div>
